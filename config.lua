...
Config.Duty = vector3(-1200.36, -902.45, 13.89)
Config.Tray =  vector3(-1190.88, -894.35, 13.89)
Config.Tray2 =  vector3(-1192.84, -893.84, 13.89)
Config.Tray3 =  vector3(-1194.81, -893.25, 13.89)
Config.Tray4 =  vector3(-1196.87, -892.78, 13.89)
Config.Storge = vector3(-1196.33, -900.9, 13.89) 
Config.Fridge = vector3(-1202.75, -897.64, 13.89)
Config.BurgerStation = vector3(-1194.8, -897.74, 13.89)
Config.Fries = vector3(-1195.31, -900.34, 13.89)
Config.Drink =  vector3(-1197.13, -896.03, 13.89)
Config.Garage = vector3(-1165.66, -887.96, 14.13) 
Config.MeatStation = vector3(-1196.93, -899.8, 13.89)
Config.PackageStation = vector3(-1194.3, -896.65, 13.89)
Config.Clean = vector3(-1193.99, -900.51, 13.89)
Config.SellItem = vector3(-1189.42, -887.09, 13.89)
Config.Finish = vector3(-1186.56, -885.2, 13.89)
...
-- Add this section to your Config table
Config.StashSave = {
    enabled = true, -- Enable SQL saving for stashes
    interval = 60000, -- Auto-save interval in milliseconds (1 minute)
    debug = false -- Enable debug logging
}

-- Ox Inventory Stash Configurations (UPDATED with owner support)
Config.Storages = {
    ['burgershot_tray1'] = {
        slots = 5,
        maxWeight = 5000,
        label = 'Burger Shot Tray 1',
        groups = {['burgershot'] = 0}, -- Anyone can access
        coords = vector3(-1190.88, -894.35, 13.89),
        owner = false -- Shared stash (no owner)
    },
    ['burgershot_tray2'] = {
        slots = 5,
        maxWeight = 5000,
        label = 'Burger Shot Tray 2',
        groups = {['burgershot'] = 0},
        coords = vector3(-1192.84, -893.84, 13.89),
        owner = false -- Shared stash
    },
    ['burgershot_tray3'] = {
        slots = 5,
        maxWeight = 5000,
        label = 'Burger Shot Tray 3',
        groups = {['burgershot'] = 0},
        coords = vector3(-1194.81, -893.25, 13.89),
        owner = false -- Shared stash
    },
    ['burgershot_tray4'] = {
        slots = 5,
        maxWeight = 5000,
        label = 'Burger Shot Tray 4',
        groups = {['burgershot'] = 0},
        coords = vector3(-1196.87, -892.78, 13.89),
        owner = false -- Shared stash
    },
    ['burgershot_storage'] = {
        slots = 40,
        ...
        groups = {['burgershot'] = 0}, -- Only burgershot employees
        coords = vector3(-1196.33, -900.9, 13.89),
        owner = false -- Shared stash for all employees
    },
    ['burgershot_fridge'] = {
        slots = 30,
        maxWeight = 150000,
        ...
        groups = {['burgershot'] = 0},
        coords = vector3(-1202.75, -897.64, 13.89),
        owner = false -- Shared stash
    },
    -- Optional: Employee lockers (personal stashes)
    ['burgershot_locker_'] = { -- Note the trailing underscore for player-specific
        slots = 10,
        maxWeight = 20000,
        label = 'Employee Locker',
        groups = {['burgershot'] = 0},
        owner = true -- Each employee gets their own personal locker
    }
}

-- Shop configuration for ox_inventory
Config.Shop = {
    ['burgershot_shop'] = {
        name = 'Burger Shot Supplies',
        coords = vector3(-1202.75, -897.64, 13.89),
        inventory = {
            { name = 'burgershot_bread', price = 10, count = 50 },
            { name = 'burgershot_lavash', price = 8, count = 50 },
            { name = 'burgershot_sauce', price = 5, count = 50 },
            { name = 'burgershot_curly', price = 4, count = 50 },
            { name = 'burgershot_tomato', price = 3, count = 50 },
            { name = 'burgershot_cheddar', price = 6, count = 50 },
            { name = 'burgershot_frozenmeat', price = 15, count = 50 },
            { name = 'burgershot_frozenrings', price = 12, count = 50 },
            { name = 'burgershot_frozennuggets', price = 12, count = 50 },
            { name = 'burgershot_smallfrozenpotato', price = 8, count = 50 },
            { name = 'burgershot_bigfrozenpotato', price = 12, count = 50 },
            { name = 'burgershot_smallemptyglass', price = 2, count = 50 },
            { name = 'burgershot_bigemptyglass', price = 3, count = 50 },
            { name = 'burgershot_coffeeemptyglass', price = 3, count = 50 },
            { name = 'burgershot_smallcardboard', price = 2, count = 50 },
            { name = 'burgershot_bigcardboard', price = 3, count = 50 },
            { name = 'burgershot_icecreamcone', price = 1, count = 50 },
        },
        groups = {['burgershot'] = 0} -- Only burgershot employees can access
    }
}